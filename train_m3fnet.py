...
class EmotionTrainer:
    def __init__(self, config):
        ...
        # Calculate and use class weights for imbalanced data
    ...
    def calculate_class_weights(self):
        ...
        emotion_counts = {}
        for emotion in self.train_features['emotions']:
            emotion_counts[emotion] = emotion_counts.get(emotion, 0) + 1
        
        total_samples = len(self.train_features['emotions'])
        class_weights = []
        
        for emotion in self.config.EMOTION_LABELS:
            count = emotion_counts.get(emotion, 1)
            # Inverse frequency weighting
            weight = total_samples / (len(self.config.EMOTION_LABELS) * count)
            class_weights.append(weight)
        
        print("Class weights:", dict(zip(self.config.EMOTION_LABELS, class_weights)))
    ...
    def train(self):
        ...
        for epoch in range(self.config.NUM_EPOCHS):
            ...
            if dev_acc > best_dev_acc:
                ...
                self.save_model('best_model_m3fnet.pth')
                patience_counter = 0
        ...
        self.load_model('best_model_m3fnet.pth')
    ...
    def load_model(self, filename):
        ...
        try:
            ...
            try:
                ...
                print("Loaded with weights_only=False - only use trusted models")
